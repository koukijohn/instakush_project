...
$(document).ready(function () {
  ...
  $.ajax({
    type: 'POST',
    url: 'http://0.0.0.0:5001/api/v1/dispensary_search/',
    data: JSON.stringify({}),
    dataType: 'json',
    contentType: "application/json",
    success: function(data) { dispensaryFunction(data) },
  });
